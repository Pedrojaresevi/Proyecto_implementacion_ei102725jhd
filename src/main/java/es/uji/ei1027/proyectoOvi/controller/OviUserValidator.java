...
public class OviUserValidator implements Validator {
    ...
    public void validate(Object obj, Errors errors) {
        ...
        if (oviUser.getDateOfBirth() == null) {
            ...
            LocalDate fechaMayoriaEdad = today.minusYears(18);
        ...
        if (esMenorDeEdad) {
            if (oviUser.getTutor_id() == null || oviUser.getTutor_id().trim().isEmpty()) {
                errors.rejectValue("tutor_id", "obligatorio_menor", "El documento del tutor es obligatorio para menores de edad.");
